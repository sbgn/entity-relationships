...
\item all the relevant \glyph{interactors} of the \glyph{interaction} targeted by the \glyph{stimulation}
...
\begin{figure}[H]
  ...
  \caption{Example of a \glyph{stimulation} \add{targeting} a \glyph{phenotype} ``Long Term Potentiation (LTP)'' enhanced when the entity ``GluR'' is present in the post-synaptic density.}
