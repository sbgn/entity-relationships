...
\subsection{Cis and trans relationships}\label{sec:semanticsDomain}

% No functional relationship between container and domains. All relationships must be explicit 

% location: Container control domains, domain does not control container

% existence: Container control domains, domain does not control container
