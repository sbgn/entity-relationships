...
\ifbool{draft}{
    ...
    \DeclareDocumentCommand{\corr}{ O{Correction} m  m }{
        ...
        \refstepcounter{modification}
        \label{mod:\themodification}
        \addcontentsline{mod}{modification}{\protect\numberline{\thesection.\themodification} \hspace{1.0cm} \old-[#2]\new+[#3]}
        \endgroup
    }
    ...
    \DeclareDocumentCommand{\add}{ O{Addition} m }{
        \begingroup
            ...
            \refstepcounter{modification}
            \label{mod:\themodification}
            \addcontentsline{mod}{modification}{\protect\numberline{\thesection.\themodification} \hspace{1.0cm} \new+[#2]}
        \endgroup
    }
...
\ifbool{draft}{
    ...
    \newcommand{\czauderna}[1]{\todo[color=orange!30]{Tobias: #1}}
