...
Having two outcomes and two stimulation links (\fig{asynchronous}) does not work in this case because all statement on \ERm are independent. So it is possible that \glyph{entity} $B$ is created, but \glyph{entity} $A$ is not deleted. 
