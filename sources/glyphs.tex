...
Influence arcs represent the effect of an entity on another relationship. The symbols attached to their extremities precise their semantics. SBGN \ER{}'s influences can be viewed as logical rules linking interactors and other rules. \SBGNERLone{} provides seven influences, \glyph{modulation}, \glyph{stimulation}, \glyph{inhibition}, \glyph{necessaryStimulation}, \glyph{absoluteInhibition}, \glyph{absoluteStimulation}, \glyph{logicArc}.
