...
\glyph{Entity nodes} represent element of truth, things that exist. 
...
Interactors are entity nodes that are able to participate in an (\sect{interaction}). \SBGNERLone{} provides two interactors, the \glyph{entity} and the \glyph{outcome} of a statement.
...
\glyph{Statements} can be true or false. \glyph{Statements} are targets of \glyph{influences}. They are not true themselves, but can carry truth element (\glyph{outcomes}, see \sect{outcome}). \SBGNERLone{} provides four types of statements, \glyph{assignment}, \glyph{interaction}, \glyph{non-interaction} and \glyph{observable}.
