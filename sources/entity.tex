...
\begin{figure}[H]
  ...
  \caption{Example of an \glyph{entity} named CaMKII, that carries a global state variable representing the residu threonine 286, a global unit of information precising its material status (protein), two domains, catalytic and regulatory, the latter carrying a local state variable representing the residu threonine 306.}
  \label{fig:ex-entity}
\end{figure}
