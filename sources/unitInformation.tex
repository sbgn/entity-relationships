...
\begin{figure}[H]
  ...
  \caption{Using \glyph{units of information} to represent the fact that the entity ``CaMKII'' is a protein, and to display intra- (cis) and inter- (trans) molecular interactions.}
