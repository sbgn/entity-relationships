...
%\newcommand{\sbgndate}{16 June, 2008}
...
\newcommand{\SBGNERLone}{SBGN \ER Level~1\xspace}
...
% ----------------------------------------------------------------
% The following commands are commented because they clash other commands
% defined in the latex-draft source
