...
\SBGNERLone defines a glyph to add additional information to a map, that does not modify the \corr{semantic}{semantics} of the graph. This glyph can be used to add free text, or links to external information.
