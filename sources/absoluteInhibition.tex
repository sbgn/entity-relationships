...
An \glyph{absolute inhibition} precludes the existence of another relationship. A relationship modulated by an absolute inhibition can only exist when an absolute inhibition is false, whatever are the other influences this relationship is subjected to.
...
\begin{glyphDescription}
 ...
 \glyphEndPoint The target extremity of \corr{a}{an} \glyph{absolute inhibition} carries a double bar perpendicular to the arc (to remind that it is an \glyph{inhibition}).
 \glyphAux A \glyph{unit of information} carrying the mention \glyph{cis} or \glyph{trans} precises the relationship between the \glyph{entity node} from which the \glyph{absolute inhibition} origins and either:
\begin{itemize}
...
\begin{figure}[H]
  ...
  \caption{The \ER glyph for \glyph{absolute inhibition}.}
