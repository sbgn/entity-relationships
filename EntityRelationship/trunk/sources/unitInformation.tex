...
\begin{figure}[H]
  ...
  \caption{Using a \glyph{unit of information} to represent the fact that the entity ``CaMKII'' is a protein, that the interaction is a cis-interaction, identified by its anchor ``catal'' and ``regul''.}
