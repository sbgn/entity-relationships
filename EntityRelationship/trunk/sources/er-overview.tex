...
The essence of the \ERs is to depict the influences of entities upon the behaviour of others. The entities are things that exist, either on their own, or when statements become true. For instance, an entity can exist (such as ``entity 1'' in \fig{eg1}), different entities can interact (such as ``entity 1'' and ``entity 2'' in \fig{eg1}), or a value can be assigned to an entity's property (such as ``value 1'' to property ``var'' of ``entity 1'' in \fig{eg1}). The influences can therefore be understood as logical consequences of this existence. The stimulation of the interaction between ``entity 1'' and ``entity 2'' in \fig{eg1} takes place if `value 1'' is really assigned to property ``var'' of ``entity 1''. The existence of the assignment is represented by the black dot (called \glyph{outcome}). On the contrary to the \PDl, where the different processes affect each other in a way that the behaviour of the depicted system can only be understood taking into account the whole system, the relationships are essentially independent. On can imagine that each of the relationships represents a specific conclusion of a scientific experience reported in an article. Their addition on a map represents the knowledge we have of the effects of the entities represented upon each other. In  \fig{eg1}, we have three statements: 
...
\newcolumntype{P}[1]{>{\raggedright\hspace{0pt}\arraybackslash}p{#1}}
 ...
 \begin{table}[h]
   ...
   \begin{tabular}{@{}lP{2.4in}P{2.4in}@{}}
     ...
     \midrule
     Entity node
     & Something that exists, whether a physical object or sets of objects, or something that happens.  
