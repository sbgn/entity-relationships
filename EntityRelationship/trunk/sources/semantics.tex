...
\noindent
A \glyph{not} linking an \glyph{interactor} $I$ and an influence $F$ means: ``$F$ takes place if $I$ does not exist''.\\[\baselineskip]

\noindent
A \glyph{delay} linking an \glyph{interactor} $I$ and an influence $F$ means: ``If $I$ exists then $F$ takes place, but not immediately''.\\[\baselineskip]
