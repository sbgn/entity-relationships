...
The text that appears as the unit of information decorating an entity must be prefixed with a controlled vocabulary term indicating the type of information being expressed.  The prefixes are mandatory.  Without the use of controlled vocabulary prefixes, it would be necessary to have different glyphs to indicate different classes of information; this would lead to an explosion in the number of symbols needed. There is no more than one \glyph{units of information} per controlled vocabulary allowed for any \glyph{Entity}. So, for example, one \glyph{units of information} of material type and one \glyph{units of information} of conceptual type.
