...
Some glyphs in SBGN \ERs can contain particular kinds of textual annotations conveying information relevant to the purpose of the glyph.  These annotations are carried by \glyph{units of information} (\sect{unitInfo}) or \glyph{state variable values} (\sect{stateVariable}).
...
\begin{table}[h]
  ...
  \begin{tabular}{l>{\ttfamily}l>{\ttfamily}l}
    ...
    \bottomrule
  \end{tabular}
  \caption{Miscellaneous controlled terms. For the cardinality, \texttt{\#} stands for the
