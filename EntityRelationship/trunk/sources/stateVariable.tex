...
\glyphContainer A \glyph{state variable} is represented by a ''stadium'' container, that is two hemicercles of same radius joined by parellel segments, as shown in \fig{state-var}.  The parallel segament axis should be tangent to the border of the glyph of the \glyph{EN} being modified by the \glyph{state variable}. The center of the bounding box of a \glyph{state variable} should be located on the mid-line of the border of the \glyph{EN}.
